...
public class EBookController {
    ...
    @RequestMapping("/UserGetEbook")
    public String userGetEbook(@RequestParam(value = "name", required = false) String name, @RequestParam(required = false, defaultValue = "1") String num, Model model) {
        EBook eBook = new EBook();
        eBook.setEbookName(name);
        pageParam.setParam(eBook);
        pageParam.setPageNum(Integer.parseInt(num));
